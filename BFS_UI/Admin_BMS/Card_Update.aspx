<%@ Page Title="修改卡牌信息" Language="C#" MasterPageFile="~/Admin_BMS/Admin.Master" AutoEventWireup="true" CodeBehind="Card_Update.aspx.cs" Inherits="BFS_UI.Admin_BMS.Card_Update" %>
         ...
         <div class="grid_10">
            ...
            <div style="width: 100%; height: 700px; margin-top: 20px">
                <table style="width:100%;height:100%;">
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" Text="卡牌名称"></asp:Label></td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label3" runat="server" Text="卡牌费用"></asp:Label></td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label4" runat="server" Text="卡牌稀有度"></asp:Label></td>
                        <td>
                            <asp:Label ID="rd" runat="server" Text=""></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label5" runat="server" Text="生命值/耐久度"></asp:Label></td>
                        <td>
                            <asp:Label ID="hp" runat="server" Text=""></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label6" runat="server" Text="攻击力"></asp:Label></td>
                        <td>
                            <asp:Label ID="ap" runat="server" Text=""></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label7" runat="server" Text="卡牌效果描述"></asp:Label></td>
                        <td>
                            <asp:Label ID="effect" runat="server" Text=""></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label9" runat="server" Text="卡牌特性" />
                        </td>
                        <td>
                            <asp:Label ID="ch" runat="server" Text=""></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label10" runat="server" Text="卡牌种族"></asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="race" runat="server" Text=""></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label11" runat="server" Text="卡牌所属职业"></asp:Label></td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label12" runat="server" Text="所属卡牌集"></asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="off" runat="server" Text=""></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label13" runat="server" Text="卡牌图片"></asp:Label>
                        </td>
                        <td>   <asp:Image ID="img" runat="server" Height="300px" Width="200px"/> </td>
                        <td>
                            <asp:FileUpload ID="FileUpload_img" runat="server" />
                        </td>
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="请选择卡牌图片" ControlToValidate="FileUpload_img" ForeColor="Red"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                </table>
            </div>
            <div style="margin-left: 500px; margin-top: 15px;">
               <asp:Button ID="UpdateCard" runat="server" Text="修改" CssClass="btn btn-primary" Width="100px" OnClick="UpdateCard_Click"/>
            </div>
        </div>  
    </div>
</asp:Content>
