<%@ Page Title="删除帖子评论的回复" Language="C#" MasterPageFile="~/Admin_BMS/Admin.Master" AutoEventWireup="true" CodeBehind="BBS_Comment_Back.aspx.cs" Inherits="BFS_UI.Admin_BMS.BBS_Post_Top" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="grid_10">
            <div class="box round first grid"> <h2>
                <asp:Label ID="Label4" runat="server" Text="评论列表管理" Font-Size="15" Font-Names="微软雅黑"></asp:Label>
           </h2>      
                ...
                <ItemTemplate>
                    <tbody>
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <asp:Label ID="time" runat="server" Text='<%# Eval("BCB_ID") %>'></asp:Label></td>
                            <td>
                            ...
                            <td style="text-align: left">
                                <asp:HiddenField ID="HiddenField1" runat="server" Value='<%#Eval("BCB_ID")%>' /> 
                                <asp:HyperLink CssClass="btn btn-danger" ID="btnDelete" runat="server" Text="删除" NavigateUrl='<%#"~/Admin_BMS/BBS_Comment_Back.aspx?bcbid="+ Eval("BCB_ID")%>' OnClientClick="return confirm('确认删除？')" Height="25px" Font-Size="12px" />
                            </td>
                        </tr>
                    </tbody>
                </ItemTemplate>
