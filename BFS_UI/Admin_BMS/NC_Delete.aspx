<%@ Page Title="删除评论" Language="C#" MasterPageFile="~/Admin_BMS/Admin.Master" AutoEventWireup="true" CodeBehind="NC_Delete.aspx.cs" Inherits="BFS_UI.Admin_BMS.WebForm1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">    
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <div class="grid_10">
            <div class="box round first grid"> 
                <h2><asp:Label ID="Label4" runat="server" Text="评论列表管理" Font-Size="15" Font-Names="微软雅黑"></asp:Label>
           </h2>
                ...
                <ItemTemplate>
                    <tbody>
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <asp:Label ID="time" runat="server" Text='<%# Eval("NC_ID") %>'></asp:Label></td>
                            <td>
                                ...
                                <td>
                                <asp:Label ID="class" runat="server" Text='<%# Eval("Users_Name") %>'></asp:Label></td>
                            <td>
                            ...
                            <td style="text-align: left">
                                ...
                                <asp:HyperLink CssClass="btn btn-danger" ID="btnDelete" runat="server" Text="删除" NavigateUrl='<%#"~/Admin_BMS/NC_Delete.aspx?ncid="+ Eval("NC_ID")%>' OnClientClick="return confirm('确认删除？')" Height="25px" Font-Size="12px" />
                            </td>
                        </tr>
                    </tbody>
                </ItemTemplate>
